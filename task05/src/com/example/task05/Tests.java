...
public class Tests {
     ...
     * Если этот метод падает, то скорее всего некорректно реализован метод {@link PolygonalLine#setArrPoints(Point[])}, который
    ...
    /**
     * Тестирование модификации массива точек
     * Если этот тест падает, то скорее всего некорректно реализован метод {@link PolygonalLine#setArrPoints(Point[])},
